...
<html>
	...
	<?php
		...
		$requete="Select * from produit where Remise!=0;";
		...
		<div class="prod">
			<table>
				...
				<tr>
					<td>Prix:</td>
					<td ><s style="color:red"><?php echo($ligne["Prix"])?></s>
					<?php echo (($ligne["Prix"]- ($ligne["Prix"]*$ligne["Remise"])/100))?></td>
				</tr>
				<tr>
					<td>Stock:</td>
				...
				<tr>
					...
					<form <input method="post" action="">
							Quantité <input  type="number_format" name="quantite" >
					</form>
					</td>
