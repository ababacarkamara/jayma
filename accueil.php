		...
		<div class="prod">
			<table>
				<tr>
					...
					<td rowspan=5 > <img src = "<?php echo ($ligne["Image"])?>" heigth="100px" width="150px" alt="photo"/></td>
				</tr>
				<tr>
					<td>Description:</td>
				...
				<tr>
					...
					<form <input method="post" action="">
							Quantité <input  type="number_format" name="quantite" value="submit">
					</form>
					</td>
					<td><a href='panier.php?id=<?php echo $ligne["IdProduit"]?>&quantite=<?php echo $_REQUEST["quantite"]?>'>Commander</a></td>
				</tr>
			</table>
		</div>
	<?php }
